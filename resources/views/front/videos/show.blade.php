...
@section('content')
@if (session('alert'))
<div class="alert alert-success mt-5" style="direction: rtl;">
    {{ session('alert') }}
</div>
@endif
        ...
        <div id="watch">
            ...
            <div class="video-share">
                ...
                <ul class="social_link">
                    ...
                    <li><a class="linkedin" href="#"><i class="fa-brands fa-linkedin"></i></a>
                    </li>
                    <li><a class="google" href="#"><i class="fa-brands fa-facebook"></i></a>
                    </li>
                    <li><a class="twitter" href="#"><i class="fa-brands fa-twitter"></i></a>
                    </li>
                    <li><a class="rss" href="#"><i class="fa-solid fa-rss"></i></a></li>
                </ul><!-- // Social -->
            </div><!-- // video-share -->
            <!-- // Video Player -->
