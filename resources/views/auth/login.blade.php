...
<div id="log-in" class="site-form log-in-form">
	...
	<div id="log-in-head">
		<h1>ورود</h1>
		<div id="logo"><a href="{{route('front.index')}}"><img src="img/logo.png" alt=""></a></div>
	</div>
	...
	<div class="form-output">
		...
		<form action="{{route('login.store')}}" method="post" id="login-form">
			...
			<button class="btn btn-lg btn-primary full-width g-recaptcha"
				data-sitekey="{{config('services.recaptcha.site_key')}}"
				data-callback='onSubmit'
				data-action='submit'>ثبت نام</button>
